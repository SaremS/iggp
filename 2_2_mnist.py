...
plt.xticks([])
plt.yticks([])
plt.savefig(f"../paper/img/experiments/mnist_{target_class}_image.png", transparent=False)
plt.close()
...
plt.savefig(f"../paper/img/experiments/mnist_{target_class}_chart.png", transparent=False, bbox_inches="tight")
plt.close()
